...
class Tallnut:
    def __init__(self, texture_name, x, y, screen):
        ...
        self.texture_coordinates = {
            "body_normal": (13, 11, 123, 160),
            "body_sad": (127, 11, 123, 160),
            "body_crying": (251, 11, 123, 160),
            "eyes_squint": (40, 166, 111, 208),
            "eyes_closed": (115, 165, 187, 210)
        }
        atlas_image_path = 'Plants/Assets/PC Computer - Plants vs Zombies - Tallnut.png'
